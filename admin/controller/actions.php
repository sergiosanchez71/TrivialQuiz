...
switch ($action) {
	...
	case "addToRanking":
	$player = $_REQUEST['idPlayer'];
	$idQuest = $_REQUEST['idQuest'];
	$points = $_REQUEST['points'];

	$sql = "INSERT INTO results VALUES (null, '$idQuest', '$player', '$points')";


	if (mysqli_query($mysqli, $sql)) {
		$sql2 = "SELECT * FROM results WHERE questionnaire='$idQuest' ORDER BY SCORE";
